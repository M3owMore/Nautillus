            ...
            ? 
                <div className="absolute top-20 left-0 right-0 bottom-0 flex flex-col justify-center items-center  overflow-hidden">
                    <h1 className="text-4xl font-alkSanet text-center text-secondary">
                        {props.app.langJson.words[props.app.lang].linkHasBeenSent}
                    </h1>
                </div>
            :
                <div className="absolute top-20 left-0 right-0 bottom-0 flex flex-col justify-center items-center  overflow-hidden">
                    <div className="w-full max-w-md p-4 flex flex-col  gap-6">
                        ...
                        <form className="flex flex-col justify-center items-center w-full">
                            ...
                            <div className="mt-6">
                                ...
                                >   
                                    {props.app.langJson.words[props.app.lang].sendLinkToEmail}
                                </button>
                            </div>
                        </form>
            ...
            :
                <div className="absolute top-20 left-0 right-0 bottom-0 flex flex-col justify-center items-center  overflow-hidden">
                    <div className="w-full max-w-sm p-4 flex flex-col  gap-6">
                        <h1 className="text-4xl font-alkSanet text-center text-secondary">
                        {props.app.langJson.words[props.app.lang].resetPassword}
                        </h1>
                        ...
                        <form className="flex flex-col justify-center items-center w-full">
                            ...
                            <div className="mt-6">
                                ...
                                >
                                    ...
                                    {props.app.langJson.words[props.app.lang].reset}
                                </button>
                            </div>
                        </form>
...
const ResetPassword = (props:any) => {
    ...
    return (
        <>
           {(token && uid) ? <ChangePassword app={props.app} token={token} uid={uid}/> : <SendEmail app={props.app}/>}
        </>
    )
}
