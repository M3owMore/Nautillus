    ...
    <>    
        <div className='flex flex-col justify-center items-center h-screen w-full p-4'>
            <div className='h-full w-full flex flex-col items-center justify-center text-main'>
                <h1 className='text-secondary text-5xl text-center font-alkSanet'>Get in Touch</h1>
                <p className='text-xl text-center mt-2 mb-6 font-bpgESM'>Is it feedback, question, partnership? We are all ears!</p>
