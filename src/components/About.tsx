      ...
      <div className="max-w-3xl w-full flex flex-col items-center justify-center px-4">
          ...
          <div className="w-full gap-4 flex flex-col tablet:flex-row items-center justify-center mt-2">
              <BoxAnim offset={150} className="w-full">
                <div className="w-full bg-bg-2 shadow-transparent tablet:hover:scale-105 tablet:hover:shadow-secondary duration-200 shadow-md rounded-md text-main p-4 flex justify-center tablet:justify-start gap-4">
              ...
              <BoxAnim offset={250} className="w-full">
                <div className="w-full bg-bg-2 shadow-transparent tablet:hover:scale-105 tablet:hover:shadow-secondary duration-300 shadow-md rounded-md text-main p-4 flex justify-center tablet:justify-start gap-4">
          ...
          <BoxAnim offset={300}>
            <div className="w-full shadow-transparent tablet:hover:scale-105 tablet:hover:shadow-secondary duration-300  shadow-md px-4 py-2 bg-bg-2 rounded-md flex flex-col items-center justify-center ">
              ...
              <div className="w-full flex flex-col items-center justify-center  text-secondary text-sm font-arialGeo gap-2 mt-2">
