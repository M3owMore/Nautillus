        ...
        <div className="flex flex-col justify-center items-center w-screen text-main min-h-screen gap-2">
          ...
          <div className='flex flex-col tablet:flex-row gap-6'>
            <div className='flex flex-col justify-center items-center'>
              ...
              <button className="bg-main hidden tablet:block text-xl text-black py-3 px-8 rounded-md font-bold m-6 hover:bg-zinc-300 duration-200"><span className='w-full'>{props.app.langJson.words[props.app.lang].moreQuestions}</span></button>
            </div>
            <div className='flex flex-col justify-center items-center gap-6'>
              ...
              <button className="bg-main block tablet:hidden text-xl text-black py-3 px-8 rounded-md font-bold m-6 hover:bg-zinc-300 duration-200"><span className='w-full'>{props.app.langJson.words[props.app.lang].moreQuestions}</span></button>
