      ...
      <>
        <div className="flex flex-col justify-center items-center w-screen text-main min-h-screen gap-4">
          <TypeAnimation
            ...
            cursor={true}
            repeat={Infinity}
            className = "text-4xl text-center p-1 text-secondary font-bpgESM"
          />
          ...
          <p className="text-2xl font-alkSanet text-center p-2">
            {[...props.app.langJson.words[props.app.lang].description].map((char:string, i:number) => 
              <span className='hover:text-4xl hover:text-secondary duration-75' key={i}>{char}</span>
            )}
          </p>
        ...
        <div className="flex flex-col justify-center items-center w-screen text-main min-h-screen gap-2">
          ...
          <div className='flex flex-col  tablet:flex-row'>
            <div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-4 bg-bg-2 rounded-2xl m-3 gap-2">
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <br/>
              <Link to="/courses"><button className="bg-main text-xl text-black py-3 px-8 rounded-md font-bold">{props.app.langJson.words[props.app.lang].checkCourses}</button></Link>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center items-center w-screen text-main min-h-screen gap-2">
          ...
          <div className='flex flex-row'>
            {(width >= 700) ?
            (<div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-4 bg-bg-2 rounded-2xl m-4">
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              { (width < 700) ?
                (<>
                  <div className="flex flex-col justify-center text-main p-4 bg-bg-2 rounded-2xl m-3 gap-2">
                    <p className="text-2xl text-left font-bpgESM mb-4 w-64 flex flex-row"><GiMeshNetwork className='mr-2  text-secondary text-5xl'/><span className='w-full'>{props.app.langJson.words[props.app.lang].Costumer2Name}</span></p>
                    <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Costumer2Description}</p>
                  </div>
                </>) : ""
              }
        ...
        <div className="flex flex-col justify-center items-center w-screen text-main min-h-screen gap-2">
          ...
          <div className='flex flex-row'>
            ...
            (<div className='flex flex-col justify-center items-center'>
              ...
              <button className="bg-main text-xl text-black py-3 px-8 rounded-md font-bold m-6 hover:bg-zinc-300 duration-200"><span className='w-full'>{props.app.langJson.words[props.app.lang].moreQuestions}</span></button>
            </div>) : ""}
            <div className='flex flex-col justify-center items-center'>
              ...
              { (width < 700) ?
                (<>
                  ...
                  <button className="bg-main text-xl text-black py-3 px-8 rounded-md font-bold m-6 hover:bg-zinc-300 duration-200">{props.app.langJson.words[props.app.lang].moreQuestions}</button>
                </>) : ""
              }
            </div>
          </div>
