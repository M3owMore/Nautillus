      ...
      <>
        <div className="flex flex-col justify-center items-center w-screen text-main h-screen  p-0 m-0">
          ...
          <div className='flex flex-row justify-start items-center'>
            <Link to="/signin"><button className="bg-main text-black py-3 px-6 rounded-md font-bold m-4">{props.app.langJson.words[props.app.lang].signIn}</button></Link>
            <Link to="/signup"><button className="bg-main text-black py-3 px-6 rounded-md font-bold m-4">{props.app.langJson.words[props.app.lang].signUp}</button></Link>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center items-center w-screen text-main h-screen p-0 m-0">
          ...
          <div className='flex flex-row'>
            <div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                <p className="text-2xl text-left mb-4">{props.app.langJson.words[props.app.lang].Includes1Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Includes1Description}</p>
              </div>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                <p className="text-2xl text-left mb-4">{props.app.langJson.words[props.app.lang].Includes3Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Includes3Description}</p>
              </div>
              { (width < 700) ?
                (<>
                  <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                    <p className="text-2xl text-left mb-4 w-64">{props.app.langJson.words[props.app.lang].Includes2Name}</p>
            ...
            { (width >= 700) ?
            (<div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-4">
                <p className="text-2xl text-left my-4 w-64">{props.app.langJson.words[props.app.lang].Includes2Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Includes2Description}</p>
              </div>
              <br/>
              <Link to="/courses"><button className="bg-main text-black py-3 px-10 rounded-md font-bold">{props.app.langJson.words[props.app.lang].checkCourses}</button></Link>
        ...
        <div className="flex flex-col justify-center items-center w-screen text-main h-screen p-0 m-0">
          ...
          <div className='flex flex-row'>
            ...
            (<div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-4">
                <p className="text-2xl text-left my-4 w-64">{props.app.langJson.words[props.app.lang].Costumer2Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Costumer2Description}</p>
              </div>
            </div>) : ""}
            <div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                <p className="text-2xl text-left mb-4 w-64">{props.app.langJson.words[props.app.lang].Costumer1Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Costumer1Description}</p>
              </div>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                <p className="text-2xl text-left w-64">{props.app.langJson.words[props.app.lang].Costumer3Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Costumer3Description}</p>
              </div>
              { (width < 700) ?
                (<>
                  <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                    <p className="text-2xl text-left mb-4 w-64">{props.app.langJson.words[props.app.lang].Costumer2Name}</p>
                    <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].Costumer2Description}</p>
                  </div>
                </>) : ""
              }
        ...
        <div className="flex flex-col justify-center items-center w-screen text-main h-screen p-0 m-0">
          ...
          <div className='flex flex-row'>
            ...
            (<div className='flex flex-col justify-center items-center'>
              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                <p className="text-2xl text-left w-64">{props.app.langJson.words[props.app.lang].questions2Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].questions2Description}</p>
              </div> 
              <button className="bg-main text-black py-3 px-10 rounded-md font-bold m-6">{props.app.langJson.words[props.app.lang].moreQuestions}</button>
            </div>) : ""}
            <div className='flex flex-col justify-center items-center'>

              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                <p className="text-2xl text-left mb-4 w-64">{props.app.langJson.words[props.app.lang].questions1Name}</p>
                <p className="text-xl text-left w-64">{props.app.langJson.words[props.app.lang].questions1Description}</p>
              </div>

              <div className="flex flex-col justify-center text-main p-6 bg-neutral-900 rounded-2xl m-3">
                  <p className="text-2xl text-left mb-4 w-64">{props.app.langJson.words[props.app.lang].questions3Name}</p>
