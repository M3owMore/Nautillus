...
const Pricing = (props:any) => {
    ...
    return (
        <>
            <div className="">
                <p className="text-main text-4xl text-center mt-16 font-alkSanet">{props.app.langJson.words[props.app.lang].userLevels}</p>
                ...
                <p className="text-main text-4xl text-center mt-16 font-alkSanet">{props.app.langJson.words[props.app.lang].labs}</p>
                <div className=" flex justify-center items-center flex-col tablet:flex-row">
