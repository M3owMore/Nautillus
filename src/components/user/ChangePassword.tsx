...
const  ChangePassword = (props:any) => {
    ...
    function onChangePassword(){
        ...
        console.log(user)
        axios.post(props.app.backendURL + "change this url!!!!!!!!", user, {headers: {Authorization: 'Bearer ' + props.app.cookies.get('access')}})
        .then(() => {
            setSuccess(true)
        })
        .catch(function (error) {
            if (error.response) {
                ...
                if(error.response.data.old_password){
                    errorText = "old_password: " + error.response.data.password
                }else if(error.response.data.new_password){
                    errorText = "new_password: " + error.response.data.re_password
                }else if(error.response.data.re_new_password){
                    errorText = "re_new_password: " + error.response.data.re_password
