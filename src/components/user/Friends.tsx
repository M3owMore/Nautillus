...
const Friend = (props:any) => {
    return (
        <div className="w-full h-20 bg-bg-3 rounded-xl flex items-center justify-start p-4 hover:bg-opacity-75 duration-200">
            <button className="w-full h-full flex items-center justify-start gap-4"  onClick={() => {window.location.pathname = `/users/user/${props.name}`}}>
        ...
        <>
            ...
            :
                <div className="w-full flex flex-col justify-center items-center">
                    <h1 className="text-secondary font-alkSanet text-3xl text-center my-4">{props.app.langJson.words[props.app.lang].friends}:</h1>
