...
import { BiSolidMessageSquare, BiSolidBook } from 'react-icons/bi';
    ...
    return (
        <div className={'flex flex-col w-full'}>
            <div className='py-1'>
                ...
                <NavBut text={props.app.langJson.words[props.app.lang].blogs} to="/blogs" icon={<BiSolidBook className='text-xl ml-2'/>} show={width > 700}/>
