        ...
        <div className='w-full h-full flex flex-col p-2'>  
            ...
            <div className='h-full my-3 p-2 flex flex-col justify-start overflow-y-auto'>
                {friendsChatJson.map((friend, i) => {
                    ...
                    return <Group setIsChat={props.setIsChat} key={i} _name={_friend.name} _lastMassage={_friend.lastMassage} _img={_friend.img} name={props.name} setName={props.setName} />
            })}
            </div>
