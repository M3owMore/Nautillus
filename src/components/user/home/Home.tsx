                    ...
                    <div className="bg-bg-2 w-full h-full max-w-md rounded-3xl flex items-center justify-center flex-col gap-4 p-4 shadow-md shadow-gray-800">
                            ...
                            <div className="relative flex gap-2">
                                ...
                                {settings ?
                                    <div className="fixed tablet:absolute p-4 z-20 left-2 right-2 bottom-8 tablet:bottom-auto tablet:right-auto  tablet:left-16  rounded-xl backdrop-blur-sm tablet:w-64 bg-bg-4 bg-opacity-60 gap-4 flex flex-col">
                                        ...
                                        <Link to={"/user/change/email"}><button className="text-main p-1 bg-white bg-opacity-10 hover:bg-white hover:bg-opacity-25 rounded-md w-full duration-200 flex items-center justify-center gap-2"><AiOutlineMail className="text-lg"/> Change Email</button></Link>
                        ...
                        <div className="flex w-full flex-col tablet:flex-row gap-2 items-center justify-around">
                            <div className="flex items-center gap-2">
                                <Link to={"/user/friends"}><button className="py-1 px-3 text-main font-arialGeo bg-bg-4 rounded-md bg-opacity-60 duration-200 hover:bg-opacity-100">Friends</button></Link>
                                <Link to={"/user/friends/requests"}><button className="py-1 px-3 text-main font-arialGeo bg-bg-4 rounded-md bg-opacity-60 duration-200 hover:bg-opacity-100">Requests</button></Link>
                            </div>
                            
                            <Link to={"/users/find"}><button className="py-1 px-3 text-main font-arialGeo bg-bg-4 rounded-md bg-opacity-60 duration-200 hover:bg-opacity-100">Search Users</button></Link>
                        </div>
                    </div>
                </div>
