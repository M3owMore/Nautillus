                            ...
                            <div className="relative flex gap-2">
                                ...
                                {settings ?
                                    <div className="fixed tablet:absolute p-4 z-20 left-2 right-2 bottom-8 tablet:bottom-auto tablet:right-auto  tablet:left-16  rounded-xl backdrop-blur-sm tablet:w-64 bg-bg-4 bg-opacity-60 gap-4 flex flex-col">
                                        <Link to={"/user/change/name"}><button className="text-main p-1 bg-white bg-opacity-10 hover:bg-white hover:bg-opacity-25 rounded-md w-full duration-200 flex items-center justify-center gap-2"><BsFillPencilFill className="text-lg"/>{props.app.langJson.words[props.app.lang].changeName}</button></Link>
                                        <Link to={"/user/change/profile"}><button className="text-main p-1 bg-white bg-opacity-10 hover:bg-white hover:bg-opacity-25 rounded-md w-full duration-200 flex items-center justify-center gap-2"><FaUserCircle className="text-lg"/> {props.app.langJson.words[props.app.lang].changePFP}</button></Link>
                                        <Link to={"/user/change/email"}><button className="text-main p-1 bg-white bg-opacity-10 hover:bg-white hover:bg-opacity-25 rounded-md w-full duration-200 flex items-center justify-center gap-2"><AiOutlineMail className="text-lg"/> {props.app.langJson.words[props.app.lang].changeEmail}</button></Link>
                                        <Link to={"/user/change/password"}><button className="text-main p-1 bg-white bg-opacity-10 hover:bg-white hover:bg-opacity-25 rounded-md w-full duration-200 flex items-center justify-center gap-2"><AiFillLock className="text-lg"/> {props.app.langJson.words[props.app.lang].changePassword}</button></Link>
                                        ...
                                        <button onClick={async () => {
                                                ...
                                                className="text-main p-1 bg-white bg-opacity-10 hover:bg-white hover:bg-opacity-25 rounded-md w-full duration-200 flex items-center justify-center gap-2"><FaDoorOpen className="text-lg"/> {props.app.langJson.words[props.app.lang].logOff}</button>
