                ...
                <div className="flex flex-col items-center justify-center bg-bg-2 rounded-xl max-w-3xl p-4  tablet:p-8 w-full gap-4">
                    <div className="flex flex-row items-center justify-around w-full mb-6">
                        ...
                        <div className="flex gap-2">
                            <button disabled={isFriend} onClick={sendFriendRequest} className=" disabled:bg-opacity-50 flex items-center justify-center gap-2 bg-secondary hover:bg-opacity-70 duration-200 text-sm text-black rounded-full py-2 px-2  font-bold"><BsPersonFillAdd className="text-3xl"/></button>
