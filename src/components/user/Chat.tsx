...
const Chat = (props:any) => {
    ...
    useEffect(() => {
        socket.sendJsonMessage({'command': 'fetch_messages', 'room_name': props.chat.name, 'user_name': props.app.user.name});
    }, [props.chat])
    ...
    useEffect(() => {
        if (socket.lastJsonMessage !== null) {
            ...
            if (data['command'] === 'fetch_messages'){
                ...
                setTimeout(() => {scrollToBottomRef.current.scrollIntoView()}, 5);
            }
