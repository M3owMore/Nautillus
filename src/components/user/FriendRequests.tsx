            ...
            :
                <div className="w-full flex flex-col justify-center items-center">
                    ...
                    <div className="w-full max-w-xl flex flex-col justify-start items-center p-4 gap-4">
                        {requests !== null ? requests.map((request:any, i:number) => <Request onDecline={onDecline} onAccept={onAccept} i={i}  pfp={request.profile_picture} name={request.user_name} key={i}/>) : null}
                    </div>
                </div>
            }
        </>
