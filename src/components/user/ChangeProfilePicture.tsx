...
const ProfileImg = (props:any) => {
  ...
  return (
    <button onClick={() => {props.setImg(`/userImages/${props.i}.webp`); props.setId(props.i)}}>
      <img src={`/userImages/${props.i}.webp`} className={"w-20 h-20 m-2 rounded-full duration-200 border-2 " + (props.img === `/userImages/${props.i}.webp` ? " border-secondary" : " border-transparent")}/>
    </button>
  )
}
