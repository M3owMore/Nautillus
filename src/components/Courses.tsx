...
const CourseBox = (props:any) => {
    return (
        <div onClick={() => {window.location.href = `/courses/info?course=${props.obj.title}`}} className="relative rounded-2xl m-4 hover:scale-105 hover:bg-bg-3 duration-200 cursor-pointer">
            ...
            <p className="text-main text-lg text-center m-2">Level: <span className=" font-bpgESM font-bold">{props.obj.level}</span></p>
