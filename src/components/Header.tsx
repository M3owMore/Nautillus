...
const  Header = (props:any) => {
    ...
    return (
      <>
        ...
        <div className={"flex z-10 h-20 top-0 left-0 justify-between items-center w-screen px-4 py-2 text-main bg-bg transition-all  backdrop-blur-sm bg-bg-1 bg-opacity-40" + ((scrollPosition > 200) ? " fixed header-appear" : "")} >
