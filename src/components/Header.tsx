...
const Notifications = (props:any) => {
  return (
    <div className="p-2 nots-appear fixed tablet:absolute flex items-center justify-start flex-col rounded-xl z-20 top-24 tablet:top-10 left-8 right-8 tablet:left-auto tablet:right-auto  tablet:w-64  h-96 bg-bg-4 bg-opacity-90">
    </div>
  )
}
