        ...
        {props.app.user.canUseApp === 1  ? null
          : props.app.user.canUseApp === -1 ?
            <div className="w-full h-full hidden tablet:flex justify-center items-center gap-1 font-alkSanet">
              ...
              <Link to="/about"><p className={"mx-2 text-lg link link-underline  hover:text-secondary" + ((location.pathname === "/about") ? " font-extrabold text-secondary hidden" : "")}>{props.app.langJson.words[props.app.lang].about}</p></Link>
              ...
              ? 
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    <Notifications nots={nots} app={props.app}/>
                  </div>
