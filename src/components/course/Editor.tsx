...
const Editor = (props:any) => {
    ...
    return (
        <div className={'flex flex-col w-full h-full items-center gap-2 p-3 ' + (props.bool ? null : " hidden")}>
            <div className="relative w-full h-1/2">
                ...
                <button onClick={onRunCode} disabled={output === undefined} className=' disabled:text-red-900 text-lime-500 hover:text-lime-900 duration-500 absolute  bottom-2 right-4'><BsPlayCircleFill className="text-3xl"/></button>
            </div>
