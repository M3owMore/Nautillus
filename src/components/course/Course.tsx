        ...
        <>
            ...
            :
                <div className="absolute overflow-visible  -z-10 top-20 left-0 right-0 bottom-0 flex flex-row items-center justify-center">
                    ...
                    {width > 800 || isCourse  ? <Info handlePreviousPage={handlePreviousPage} handleNextPage={handleNextPage} courseText={course.results[0].main_text} app={props.app} isNav={isNav} setIsNav={setIsNav}/> : null}
