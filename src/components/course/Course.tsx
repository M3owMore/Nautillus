            ...
            : 
                ...
                :
                    <div className="absolute -z-10 top-20 left-0 right-0 bottom-0 flex flex-row items-center justify-center">
                        ...
                        <Info bool={width > 800 || isCourse}  name={name} handlePreviousPage={handlePreviousPage} handleNextPage={handleNextPage} courseText={course.results[0].main_text} app={props.app} isNav={isNav} setIsNav={setIsNav}/>
                        <Editor bool={width > 800 || !isCourse} name={name} code={course.results[0].code} app={props.app}/>
                    </div>
                }          
        </>                   
    );
