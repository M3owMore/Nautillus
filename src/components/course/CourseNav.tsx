...
const CourseNav = (props:any) => {
  ...
  return (
    <div className={"w-56 tablet:w-96 bg-bg-2 z-10 bg-opacity-75 backdrop-blur-sm duration-300" + (props.isNav ? " translate-x-0" : props.width <= 800 ? " -translate-x-full" : null ) + (props.width <= 800 ? " fixed left-0 top-20 bottom-0" : " h-full")}>
