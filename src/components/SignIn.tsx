                    ...
                    <form className="mt-6 flex flex-col justify-center items-center">
                        ...
                        <div className="mt-6">
                            <button 
                                ...
                                onClick={
                                async () => {
                                    const data = await axios.post(props.app.backendURL + "/", {email, password})
                                    props.app.cookies.set('refresh', data.data.refresh, { path: '/' })
                                    props.app.cookies.set('access', data.data.access, { path: '/' })
                                }}
                            >
