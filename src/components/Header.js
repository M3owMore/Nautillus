          ...
          <div className="mx-4 flex justify-center items-center">
            ...
            ?
              <>
                ...
                <Dropdown options={options} onChange={(e) => {props.app.setLang(options.indexOf(e.value)); props.app.cookies.set('lang', options.indexOf(e.value), { path: '/' }); window.location.reload(true)}} placeholder={options[props.app.lang]} />
          ...
          <div className="flex flex-col h-full">
            <div className="flex flex-col justify-center  text-gray-50">
              ...
              {props.app.user.isUser
                ? 
                  <>
                    <button className="bg-main text-black py-2 px-2 rounded-md font-bold my-4 hover:bg-zinc-300 duration-200">Log off</button>
                  </>
                :
